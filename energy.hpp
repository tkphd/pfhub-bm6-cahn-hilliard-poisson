...
const double tolerance = 2.5e-9;         // threshold residual ||b - Ax||₂ required to end iteration
const unsigned int residual_step = 1000; // number of iterations between residual computations
